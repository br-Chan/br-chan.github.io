...
function HexagonBackground({
	...
	return (
		<div
			className={cn(
				"relative size-full overflow-hidden bg-neutral-50 dark:bg-neutral-900",
				className,
			)}
								...
								(_, colIndex) => (
									<div
										...
										className={cn(
											...
											"hover:after:bg-neutral-50 hover:after:opacity-100 hover:after:duration-0 hover:before:bg-neutral-100 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-900 dark:hover:before:bg-neutral-800",
